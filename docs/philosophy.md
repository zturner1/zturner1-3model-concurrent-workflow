...
When you run AI tools from a terminal:
...
- You can generate documents, outlines, and plans without copy-paste

For example, you can ask Gemini to:

- Research a topic
- Compile reputable sources
...
## Context Files Change Everything
...
Every time you reopen Gemini in that folder, it automatically loads this context.
...
Agents are specialized sub-AIs you can delegate tasks to.

Instead of bloating a single conversation, you can:

- Create agents with specific roles
- Give them fresh context windows
- Let them research, critique, or generate content independently

Your main conversation stays clean and focused while agents do the heavy lifting.

This eliminates one of the biggest problems with AI workflows: context overload.
...
- Have one agent research hardware
- Another analyze an outline
- Another critique your work
- Another search the web using a different model

All simultaneously.  
All inside the same project folder.  
All writing to files you own.

Each agent gets a fresh context window, so nothing interferes with anything else.

This feels less like chatting with AI and more like managing a small team.

---

## Output Styles: Tuning the AI to You

Claude Code also supports **output styles**, which are customizable system prompts.
...
Instead of rewriting prompts constantly, you select the role and move on.

---

## Using Multiple AI Tools Together

You can run multiple AI tools in the same project directory.
...
Your project becomes tool-agnostic.
...
The AI is no longer the container.  
Your filesystem is.
...
- Makes AI collaborative instead of conversational

Once you experience this workflow, browser-based AI starts to feel primitive.
